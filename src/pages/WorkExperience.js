...
const WorkExperience = () => {
  return (
    <main className="p-5 bg-coffee-300 text-coffee-100">
      <section className="work-experience space-y-8">
        <h2 className="text-3xl font-bold mb-6">Work Experience</h2>

        <div className="mb-8 flex flex-row items-center">
          <img src={UofGLogo} alt="UofG" className="mr-8 h-40 w-40 rounded-lg" />
          <div>
        ...
        <div className="mb-8 flex flex-row items-center">
          <img src={MCAPLogo} alt="MCAP" className="mr-8 h-40 w-40 rounded-lg" />
          <div>
